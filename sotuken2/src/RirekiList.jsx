...
export default class Rirekilist extends React.Component {
    constructor() {
        super();
        this.state = {
            url: "/user/histories?user_id=11112345678",
            list: []
        }
    }
    componentDidMount() {
                                    ...
                                    <ul>
                                        <li className="box3">
                                            ...
                                            <div className="container">
                                                ...
                                                <div className="item1"><button>いいね</button></div>
                                                <div className="item2"><button>ブックマーク</button></div>
                                            </div>
                                        </li>
                                    </ul>
