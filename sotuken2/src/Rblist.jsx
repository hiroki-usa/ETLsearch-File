...
export default class Rblist extends React.Component {
    constructor() {
        super();
        this.state = {
            url: "/articleList/?term=",
            list: [],
            current:1,
            id: "",
            id2:"",
    ...
    componentDidMount() {
        fetch(this.state.url + this.props.keyword + "&page_num=" + this.state.current )
            .then(res => {
                                ...
                                return (
                                    <ul>
                                        <li className="box3">
                                            ...
                                            <div className="container">
                                                <div className="item">論文ID：{element.id}　出版日：{element.published_date}</div>
